...
class ExampleManagerClass2 {
  ...
  Init(){
    this.instances.container = this.controller.get_content_instance("example2");
...
window.CAppControll3r.add_module(new ExampleManagerClass2(),'example-class-2',true)